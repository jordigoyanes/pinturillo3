...
export default {
  ...
  methods: {
    ...
    this.drawLine(this.current.x, this.current.y, mouseupX, mouseupY, this.current.color, true);
    this.drawing = false;
    },
    onMouseMove(e){
      if (!this.drawing) { return; }
      ...
      this.drawLine(this.current.x, this.current.y, mousemoveX, mousemoveY, this.current.color, true);
